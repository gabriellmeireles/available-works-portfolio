        ...
        <div class="modal-content">
            ...
            <form id="softDeleteForm" action="" method="POST"> {{-- o action vem do modal-functions.js --}}
                ...
                <div class="modal-body">
                    Tem certeza que deja deletar a Série <strong><span id='serieName'></span></strong>? {{-- O Name da serie vem da view index e é setada pelo modal-functions.js 'categoryName' --}}
                </div>
