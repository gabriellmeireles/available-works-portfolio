                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col-md-7">
                                            <div class="card-body">
                                                ...
                                                <p class="card-text"><small class="text-muted">series: {{$artist->count()}}</small></p>
                                            </div>
                                            ...
                                            <div class="d-flex justify-content-center pt-5 pb-1">
                                                <a class="text-decoration-none" href="{{ route('series.index',['artist' => $artist->id]) }}">Obras Disponíveis</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
